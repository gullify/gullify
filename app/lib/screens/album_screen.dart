          ...
          children: [
            ...
            for (final (i, song) in d.songs.indexed)
              SongTile(
                ...
                // L'entête donne déjà l'artiste de l'album — et l'album.
                showArtist: false,
                showAlbum: false,
                onTap: () => ref
                    .read(playerActionsProvider)
...
/// En-tête d'album : titre, artiste, année et nombre de titres, posés sur la
/// pochette. La mise en page — plein cadre au téléphone, pochette à côté du
/// titre sur grand écran — est celle de [DetailHero], partagée avec la fiche
/// artiste.
