...
mixin _$Album {
 ...
 int get id; String get name; int? get artistId; String? get artistName; int? get year; String? get artworkUrl; int get songCount; int? get totalDuration;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,artistId,artistName,year,artworkUrl,songCount,totalDuration);

@override
String toString() {
  return 'Album(id: $id, name: $name, artistId: $artistId, artistName: $artistName, year: $year, artworkUrl: $artworkUrl, songCount: $songCount, totalDuration: $totalDuration)';
}
...
@useResult
$Res call({
 int id, String name, int? artistId, String? artistName, int? year, String? artworkUrl, int songCount, int? totalDuration
});
...
/// Create a copy of Album
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? artistId = freezed,Object? artistName = freezed,Object? year = freezed,Object? artworkUrl = freezed,Object? songCount = null,Object? totalDuration = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  int? artistId,  String? artistName,  int? year,  String? artworkUrl,  int songCount,  int? totalDuration)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Album() when $default != null:
return $default(_that.id,_that.name,_that.artistId,_that.artistName,_that.year,_that.artworkUrl,_that.songCount,_that.totalDuration);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  int? artistId,  String? artistName,  int? year,  String? artworkUrl,  int songCount,  int? totalDuration)  $default,) {final _that = this;
switch (_that) {
case _Album():
return $default(_that.id,_that.name,_that.artistId,_that.artistName,_that.year,_that.artworkUrl,_that.songCount,_that.totalDuration);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  int? artistId,  String? artistName,  int? year,  String? artworkUrl,  int songCount,  int? totalDuration)?  $default,) {final _that = this;
switch (_that) {
case _Album() when $default != null:
return $default(_that.id,_that.name,_that.artistId,_that.artistName,_that.year,_that.artworkUrl,_that.songCount,_that.totalDuration);case _:
  return null;
...
class _Album implements Album {
  const _Album({required this.id, required this.name, this.artistId, this.artistName, this.year, this.artworkUrl, this.songCount = 0, this.totalDuration});
...
/// Create a copy of Album
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? artistId = freezed,Object? artistName = freezed,Object? year = freezed,Object? artworkUrl = freezed,Object? songCount = null,Object? totalDuration = freezed,}) {
  return _then(_Album(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,artistId: freezed == artistId ? _self.artistId : artistId // ignore: cast_nullable_to_non_nullable
